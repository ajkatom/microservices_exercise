...
var Controller = function (_a) {
    ...
    var _j = control || methods.control, defaultValues = _j.defaultValues, setValue = _j.setValue, register = _j.register, unregister = _j.unregister, errors = _j.errors, _k = _j.mode, isOnSubmit = _k.isOnSubmit, isOnBlur = _k.isOnBlur, _l = _j.reValidateMode, isReValidateOnBlur = _l.isReValidateOnBlur, isReValidateOnSubmit = _l.isReValidateOnSubmit, isSubmitted = _j.formState.isSubmitted, fields = _j.fields;
    ...
    React.useEffect(function () {
        registerField();
        return function () { return unregister(name); };
